package dev.micalobia.micalibria.block.entity;
...
public abstract class MBlockEntity extends BlockEntity {
	public MBlockEntity(BlockEntityType<?> type, BlockPos pos, BlockState state) {
